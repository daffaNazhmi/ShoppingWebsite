            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                          <br/>
                          <form action="{{route('TambahStore')}}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-3" for="last-name"  name="namaKategori">Nama Kategori</label>
                              <div class="col-md-7">
                                <input type="text" name="nameKategori" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <center>

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                          <br/>
                          <form action="{{route('BarangStore')}}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            <div class="form-group">
                              <label class="control-label col-md-3" for="first-name">Gambar</label>
                              <div class="col-md-7">
                                <input type="file" name="nameGambar" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3" for="last-name">Nama Barang</label>
                              <div class="col-md-7">
                                <input type="text" name="nameNamaBarang" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3" for="last-name">Kategori</label>
                              <div class="col-md-7">
                                <select name="nameKategoriId" class="form-control">
                            ...
                            <div class="form-group">
                              <label class="control-label col-md-3" for="last-name"  name="namaKategori">Stok</label>
                              <div class="col-md-7">
                                <input type="text" name="nameStok" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3" for="last-name"  name="namaKategori">Harga</label>
                              <div class="col-md-7">
                                <input type="text" name="nameHarga" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <center>
                                <button class="btn btn-primary btn-xl">Tambah</button>
                            </center>
                          </form>
                        </div>
                      </div>

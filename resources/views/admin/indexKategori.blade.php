            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Data Kategori</h2>
                            <a href="{{ route('TambahKategori') }}"><button type="button" class="btn btn-round btn-primary" style="margin-left:790px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</button></a>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                  ...
                                  <td class="w-25">
                                      <center>
                                      <a href="{{route('EditKategori',$item->id)}}"><button type="button" class="btn btn-round btn-warning"><i class="fa fa-pencil"></i>&nbsp;Edit</button></a>
                                      <a href="{{route('HapusBarang',$item->id)}}"><button type="button" class="btn btn-round btn-danger" onclick="return confirm('Yakin data ini dihapus?')"><i class="fa fa-trash"></i>&nbsp;Delete</button></a>
                                      </center>
                                  </td>                   
                                </tr>
                                </tbody>

          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="clearfix"></div>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Data Pesanan <small>Bordered table subtitle</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="w-25">
                                        ...
                                        <a href=""><button type="button" class="btn btn-round btn-danger"><i class="fa fa-trash"></i>&nbsp;Delete</button></a> --}}
                                        </center>
                                    </td>
                                </tr>
                                </tbody>

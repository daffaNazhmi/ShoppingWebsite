				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
                            <form action="{{route('StorePesanan')}}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                @csrf
                                <div class="section-title">
                                    <h3 class="title">Billing address</h3>
                                </div>
                                <div class="form-group">
                                    <input class="input" type="text" name="nama" placeholder="Your Name">
                                </div>
                                <div class="form-group">
                                    <input class="input" type="email" name="email" placeholder="Email">
                                </div>
                                <div class="form-group">
                                    <input rows="5" class="input" type="text" name="alamat" placeholder="Address">
                                </div>
                                <center>
                                    <button class="primary-btn cta-btn">Place order</button>
                                </center>
                            </form>
						</div>
						<!-- /Billing Details -->
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
                                ...
                                <div class="order-products">
                                    ...
                                    <div class="order-col">
                                        <div><strong>TOTAL</strong></div>
                                        <div><h4 class="product-price"></h4></div>
                                    </div>
                                </div>
